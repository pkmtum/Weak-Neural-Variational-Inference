...
load_parameters_path = "/home/vincent/dfg-project/results/2024_06_25_#_30/temp_0_1.00E+07/state_dict.pt"
dont_load = ["x"]
...
flag_jump_prior = False
flag_penalty_learned = False
# -> for flag_penalty_learned = True
prior_jumpPenalty_options = dict(a_0=1e-15, b_0=1e-15, SpecialInput="x")
prior_jumps_options = dict(SpecialInput=["x", "jumpPenalty"])
# -> for flag_penalty_learned = False
# prior_jumps_options = dict(SpecialInput=["x"])
# prior_jumps_options["jumpPenalty"] = 1e1
...
num_sample_Phi = 10
min_MinMax_iterations_first_iteration = int(2e5)
min_MinMax_iterations = int(2e5)
min_MinMax_iterations_final_iteration = int(2e5)
